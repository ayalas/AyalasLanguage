...
[
    {
        ...
        ai_instruction: `I am learning ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} from ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER}. Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} sentences in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}, on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}, that I would have to translate to ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}. Then prepare a separate list with the full correct answers. In each list, separate each sentence with semi-colon. Do not include punctuations, just the sentences.`,
        ai_instruction_auto: `I am learning ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} from ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER} (on a scale of 1 to ${TOP_LEVEL}). Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} translation exercises on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}. In each exercise I would have to translate from ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} to ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}. Do not include punctuations, just the sentences. For the ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, use ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} letters. Return the result as a raw JSON array of objects in this format: {First: string, Second: string} where First would be the sentence in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} and Second would be the sentence in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}.`
    },
    {
        ...
        ai_instruction: `I am learning ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} from ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER}. Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} sentences in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}, that I would have to translate to ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}. Then prepare a separate list with the full correct answers. In each list, separate each sentence with semi-colon. Do not include punctuations, just the sentences.`,
        ai_instruction_auto: `I am learning ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} from ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER} (on a scale of 1 to ${TOP_LEVEL}). Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} translation exercises on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}. In each exercise I would have to translate from ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} to ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}. Do not include punctuations, just the sentences. For the ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, use ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} letters. Return the result as a raw JSON array of objects in this format: {First: string, Second: string} where First would be the sentence in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} and Second would be the sentence in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}.`
    },
    {
    ...
    },
    {
        ...
        ai_instruction: `I am learning ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} from ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER}. Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} sets of four or five words\\expressions in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}, on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}, each word\\expression separated by comma. Then, prepare matching sets of the translations in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}. In each list, separate each set with semi-colon. Do not include punctuations.`,
        ai_instruction_auto: `I am learning ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} from ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER} (on a scale of 1 to ${TOP_LEVEL}). Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} exercises on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}. In each exercise, preape a set of four or five words\\expressions in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}, each word\\expression separated by comma, and a matching set of the translations in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}. Do not include punctuations. For the ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, use ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} letters. Return the result as a raw JSON array of objects in this format: {First: string, Second: string} where First would be the a set of comma-separated words in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} and Second would be the matching set of comma-separated translations of those words in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}. Keep the order correct, so the first word in First matches the first word in Second, and so on.`
    },
    {
        ...
        ai_instruction: `I am learning ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} from ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER}. Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} sentences in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}, on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}, that I would have to translate to ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}. Then prepare a separate list with the full correct answers. In each list, separate each sentence with semi-colon. Do not include punctuations, just the sentences. For each sentence, generate between ${BUCKET_LIST_EXTRA_OPTIONS.MIN_WORDS} and ${BUCKET_LIST_EXTRA_OPTIONS.MAX_WORDS} words in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} that do not appear in the corresponding sentence. separate each such set of words with a semi-colon, and present this as a third list of wrong extra options.`,
        ai_instruction_auto: `I am learning ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} from ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER} (on a scale of 1 to ${TOP_LEVEL}). Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} translation exercises on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}. In each exercise I would have to translate from ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} to ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}. Do not include punctuations, just the sentences, so one would not be able to know, for instance, what's the last word according to the period at its end. For each sentence, generate between ${BUCKET_LIST_EXTRA_OPTIONS.MIN_WORDS} and ${BUCKET_LIST_EXTRA_OPTIONS.MAX_WORDS} wrong extra words in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, separated only by whitespace, that do not appear in the corresponding translated sentence. For the ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, use ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} letters. Return the result as a raw JSON array of objects in this format: {First: string, Second: string, ExtraOptions: string} where First would be the sentence in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}, Second would be the sentence in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} and ExtraOptions would be the whitespace-separated list of words in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} that do not appear in the corresponding translated sentence.`
    },
    {
        ...
        ai_instruction: `I am learning ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER}. Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} sentences in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}, that have common responses to. I would have to choose from a few options the correct response in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}. Then prepare a separate list with the full correct answers. In each list, separate each sentence with semi-colon. Do not include punctuations, just the sentences. For each response, generate between ${BUCKET_LIST_EXTRA_OPTIONS.MIN_WORDS} and ${BUCKET_LIST_EXTRA_OPTIONS.MAX_WORDS} wrong responses in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, separated by a comma(,). separate each such set of wrong responses with a semi-colon, and present this as a third list of wrong extra options.`,
        ai_instruction_auto: `I am learning ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER} (on a scale of 1 to ${TOP_LEVEL}). Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} exercises on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}. In each exercise I would have to choose a common response to the sentence presented. Both the sentence and the responses are in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}. Do not include punctuations, just the sentences and responses. Add a translation of the exchange that can include punctuations. For each correct response, generate between ${BUCKET_LIST_EXTRA_OPTIONS.MIN_WORDS} and ${BUCKET_LIST_EXTRA_OPTIONS.MAX_WORDS} wrong extra responses, separated by comma(,). Make sure these are not reasonable alternative responses, but rather incorrect ones. For the ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, use ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} letters. Return the result as a raw JSON array of objects in this format: {First: string, Second: string, ExtraOptions: string - comma(,)-separated list of options, Translation: string} where First would be the sentence to respond to, Second would be the correct response and ExtraOptions would be the comma-separated list of wrong responses to the presented sentence in First, and Translation would be the full translation of the exchange, the values of First and Second, to ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}`
    },
    {
        ...
        ai_instruction_auto: `I am learning ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER} (on a scale of 1 to ${TOP_LEVEL}). Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} exercises on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}. In each exercise I would have to write a common response to the sentence presented. Both the sentence and the responses are in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}. Do not include punctuations, just the sentences and responses. Add a translation of the exchange that can include punctuations. For the ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, use ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} letters. Return the result as a raw JSON array of objects in this format: {First: string, Second: string, Translation: string } where First would be the sentence to respond to and Second would be the correct response, and Translation would be the full translation of the exchange, the values of First and Second, to ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}`
    },
    {
        ...
        second_data_instructions: "Sentences in the language you know, separated by semi-colon(;)",
        extra_options_instructions: "Sets of words that are wrong choises in the translated sentence. Each word separated by space. Each set separated by semi-colon(;)",
        ai_instruction: `I am learning ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} from ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER}. Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} sentences in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}, that I would have to translate to ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}. Then prepare a separate list with the full correct answers. In each list, separate each sentence with semi-colon. Do not include punctuations, just the sentences. For each sentence, generate between ${BUCKET_LIST_EXTRA_OPTIONS.MIN_WORDS} and ${BUCKET_LIST_EXTRA_OPTIONS.MAX_WORDS} words in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} that do not appear in the corresponding sentence. separate each such set of words with a semi-colon, and present this as a third list of wrong extra options.`,
        ai_instruction_auto: `I am learning ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} from ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER} (on a scale of 1 to ${TOP_LEVEL}). Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} translation exercises on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}. In each exercise I would have to translate from ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} to ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}. Do not include punctuations, just the sentences, so one would not be able to know, for instance, what's the last word according to the period at its end. For each sentence, generate between ${BUCKET_LIST_EXTRA_OPTIONS.MIN_WORDS} and ${BUCKET_LIST_EXTRA_OPTIONS.MAX_WORDS} wrong extra words in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}, separated only by whitespace, that do not appear in the corresponding translated sentence. For the ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, use ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} letters. Return the result as a raw JSON array of objects in this format: {First: string, Second: string, ExtraOptions: string} where First would be the sentence in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, Second would be the sentence in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} and ExtraOptions would be the whitespace-separated list of words in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} that do not appear in the corresponding translated sentence.`
    },
    {
