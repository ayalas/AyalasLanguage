...
[
    {
        ...
        ai_instruction: `I am learning ${PLACEHOLDERS.TARGET_LANGAUGE_PLACEHOLDER} from ${PLACEHOLDERS.KNOWN_LANGAUGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER}. Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} sentences in ${PLACEHOLDERS.KNOWN_LANGAUGE_PLACEHOLDER}, on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}, that I would have to translate to ${PLACEHOLDERS.TARGET_LANGAUGE_PLACEHOLDER}. Then prepare a separate list with the full correct answers. In each list, separate each sentence with semi-colon. Do not include punctuations, just the sentences.`,
        ai_instruction_auto: `I am learning ${PLACEHOLDERS.TARGET_LANGAUGE_PLACEHOLDER} from ${PLACEHOLDERS.KNOWN_LANGAUGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER} (on a scale of 1 to ${TOP_LEVEL}). Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} translation exercises on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}. In each exercise I would have to translate from ${PLACEHOLDERS.KNOWN_LANGAUGE_PLACEHOLDER} to ${PLACEHOLDERS.TARGET_LANGAUGE_PLACEHOLDER}. Do not include punctuations, just the sentences. For the ${PLACEHOLDERS.TARGET_LANGAUGE_PLACEHOLDER}, use ${PLACEHOLDERS.TARGET_LANGAUGE_PLACEHOLDER} letters. Return the result as a raw JSON array of objects in this format: {First: string, Second: string} where First would be the sentence in ${PLACEHOLDERS.KNOWN_LANGAUGE_PLACEHOLDER} and Second would be the sentence in ${PLACEHOLDERS.TARGET_LANGAUGE_PLACEHOLDER}.`
    },
    {
        ...
        ai_instruction: `I am learning ${PLACEHOLDERS.TARGET_LANGAUGE_PLACEHOLDER} from ${PLACEHOLDERS.KNOWN_LANGAUGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER}. Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} sentences in ${PLACEHOLDERS.TARGET_LANGAUGE_PLACEHOLDER}, on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}, that I would have to translate to ${PLACEHOLDERS.KNOWN_LANGAUGE_PLACEHOLDER}. Then prepare a separate list with the full correct answers. In each list, separate each sentence with semi-colon. Do not include punctuations, just the sentences.`,
        ai_instruction_auto: `I am learning ${PLACEHOLDERS.TARGET_LANGAUGE_PLACEHOLDER} from ${PLACEHOLDERS.KNOWN_LANGAUGE_PLACEHOLDER} at level ${PLACEHOLDERS.LEVEL_PLACEHOLDER} (on a scale of 1 to ${TOP_LEVEL}). Prepare for me ${PLACEHOLDERS.NUM_OF_EXERCISES_PLACEHOLDER} translation exercises on the subject of ${PLACEHOLDERS.SUBJECT_PLACEHOLDER}. In each exercise I would have to translate from ${PLACEHOLDERS.TARGET_LANGAUGE_PLACEHOLDER} to ${PLACEHOLDERS.KNOWN_LANGAUGE_PLACEHOLDER}. Do not include punctuations, just the sentences. For the ${PLACEHOLDERS.TARGET_LANGAUGE_PLACEHOLDER}, use ${PLACEHOLDERS.TARGET_LANGAUGE_PLACEHOLDER} letters. Return the result as a raw JSON array of objects in this format: {First: string, Second: string} where First would be the sentence in ${PLACEHOLDERS.TARGET_LANGAUGE_PLACEHOLDER} and Second would be the sentence in ${PLACEHOLDERS.KNOWN_LANGAUGE_PLACEHOLDER}.`
    },
    {
