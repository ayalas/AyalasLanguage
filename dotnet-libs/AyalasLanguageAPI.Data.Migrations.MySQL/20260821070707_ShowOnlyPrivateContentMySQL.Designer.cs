...
namespace AyalasLanguageAPI.Data.Migrations.MySQL
{
    ...
    [Migration("20260821070707_ShowOnlyPrivateContentMySQL")]
    partial class ShowOnlyPrivateContentMySQL
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AyalasLanguageAPI.Data.Model.ContactUs", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("ContactUsId"));
            ...
            modelBuilder.Entity("AyalasLanguageAPI.Data.Model.ExerciseType", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("ExerciseTypeId"));
            ...
            modelBuilder.Entity("AyalasLanguageAPI.Data.Model.LearningPath", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("LearningPathId"));
            ...
            modelBuilder.Entity("AyalasLanguageAPI.Data.Model.UserMessage", b =>
                {
                    ...
                    b.Property<int?>("InResponseToUserMessageId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InResponseToUserMessageId");
            ...
            modelBuilder.Entity("AyalasLanguageAPI.Data.Model.UserMessage", b =>
                {
                    ...
                    b.HasOne("AyalasLanguageAPI.Data.Model.UserMessage", "InResponseToUserMessage")
                        .WithMany()
                        .HasForeignKey("InResponseToUserMessageId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.HasOne("AyalasLanguageAPI.Data.Model.User", "ToUser")
                        .WithMany()
                    ...
                    b.Navigation("InResponseToUserMessage");
