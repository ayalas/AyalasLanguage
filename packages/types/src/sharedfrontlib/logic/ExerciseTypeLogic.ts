...
export const EXERCISE_TYPE_LOGIC: Record<ExerciseType | 0, ExcerciseTypeLogic> = {
    ...
    [EXERCISE_TYPES.FROM_KNOWN_TO_TARGET]: createLogic({
        ...
        ai_json_format: `content: [{First: string, Second: string, Explanation: string}] where each item inside content is an exercise, First would be the sentence in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} and Second would be the sentence in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}.`
    }, {
    ...
    [EXERCISE_TYPES.FROM_TARGET_TO_KNOWN]: createLogic({
        ...
        ai_json_format: `content: [{First: string, Second: string, Explanation: string}] where each item inside content is an exercise, First would be the sentence in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} and Second would be the sentence in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}.`
    }, {
    ...
    [EXERCISE_TYPES.FILL_IN_THE_BLANKS]: createLogic({
        ...
        ai_instruction: `Each exercise consists of a sentence where there would be a need to fill in the right preposition(s) - use ___ for blanks, and the full correct sentence. Do not include optional vowel indications, if relevant to ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}. Do not include punctuations to fill, just the sentences with blanks and the full sentences with the blanks replaced by the correct answers filled. Do not add brackets arround the blanks.Make sure that the sentence with the blanks muches perfectly the full sentence, except that instead of the blanks the full sentence includes the correct preposition. Do not add letters to the sentence with blanks that do not appear in the full sentence, even if it's gramatically incomplete.`,
        ...
        ai_json_format: `content: [{First: string, Second: string, Translation: string, Explanation: string}] where each item inside content is an exercise, First would be the sentence in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} with ____ for blanks, and Second would be the sentence in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} with the blanks replaced by the correct answers, and Translation would be the sentence translation to in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}, and Explanation would be the explanation for the exercise. Example of one exercise (in this case learning English from French and not ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} from ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}): { First: "I am going ____ the store ____ my friend", Second: "I am going to the store with my friend", Translation: "Je vais au magasin avec mon ami", Explanation: "The correct preposition is 'to' for 'I am going to the store'" }`
    }, {
    ...
    [EXERCISE_TYPES.FROM_KNOWN_TO_TARGET_BUCKET]: createLogic({
        ...
        ai_instruction: `Each exercise consists of a sentence in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} and a translation in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}. Do not include punctuations, just the sentences, including not the period at the end. For each sentence, generate ${PLACEHOLDERS.NUM_OF_WRONG_OPTIONS_PLACEHOLDER} wrong extra word(s) in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} that do not appear in the corresponding translated sentence.`,
        ai_manual_format: `Return 3 lists: the first of the sentences in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}, the second of the sentences in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} and a third of the whitespace-separated list of word(s) in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} that do not appear in the corresponding translated sentence. Use semi-colon to separate each sentence or set of extra word(s).`,
        ai_json_format: `content: [{First: string, Second: string, ExtraOptions: array of strings, Explanation: string}] where each item inside content is an exercise, First would be the sentence in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}, Second would be the sentence in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} and ExtraOptions would be the list of ${PLACEHOLDERS.NUM_OF_WRONG_OPTIONS_PLACEHOLDER} word(s) in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} that do not appear in the corresponding translated sentence.`
    }, {
    ...
    [EXERCISE_TYPES.COMMON_RESPONSES_BUCKET]: createLogic({
        ...
        ai_json_format: `content: [{First: string, Second: string, ExtraOptions: array of string - list of ${PLACEHOLDERS.NUM_OF_WRONG_OPTIONS_PLACEHOLDER} wrong extra option(s) in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, Translation: string, Explanation: string}] where each item inside content is an exercise, First would be the sentence in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} to respond to, Second would be the correct response in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} and ExtraOptions would be the list of wrong responses in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} to the presented sentence in First, and Translation would be the full translation into ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} of the exchange, the values of First and Second, with pancutations for ease of read.`
    }, {
    ...
    [EXERCISE_TYPES.FROM_TARGET_TO_KNOWN_BUCKET]: createLogic({
        ...
        second_data_instructions: "Sentences in the language you know, separated by semi-colon(;)",
        extra_options_instructions: "Sets of words that are wrong choises in the translated sentence. Each word separated by space. Each set separated by semi-colon(;)",
        ai_instruction: `Each exercise consists of a sentence in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER} and a translation in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER}. Do not include punctuations, just the sentences, including not the period at the end. For each sentence, generate ${PLACEHOLDERS.NUM_OF_WRONG_OPTIONS_PLACEHOLDER} wrong extra word(s) in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} that do not appear in the corresponding translated sentence.`,
        ai_manual_format: `Return 3 lists: the first of the sentences in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, the second of the sentences in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} and a third of the whitespace-separated list of ${PLACEHOLDERS.NUM_OF_WRONG_OPTIONS_PLACEHOLDER} word(s) in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} that do not appear in the corresponding translated sentence. Use semi-colon to separate each sentence or set of extra word(s).`,
        ai_json_format: `content: [{First: string, Second: string, ExtraOptions: array of strings, Explanation: string}] where each item inside content is an exercise, First would be the sentence in ${PLACEHOLDERS.TARGET_LANGUAGE_PLACEHOLDER}, Second would be the sentence in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} and ExtraOptions would be the list of ${PLACEHOLDERS.NUM_OF_WRONG_OPTIONS_PLACEHOLDER} word(s) in ${PLACEHOLDERS.KNOWN_LANGUAGE_PLACEHOLDER} that do not appear in the corresponding translated sentence.`
    }, {
